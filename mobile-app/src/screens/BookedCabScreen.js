                    ...
                    {role == 'driver' && ((curBooking.pickup_image && appcat == 'delivery') || appcat == 'taxi') && (curBooking.status == 'ACCEPTED' || curBooking.status == 'ARRIVED') ?
                        <View style={{ flex: 1 }}>
                            <Button
                                ...
                                buttonStyle={{ height: '100%', backgroundColor: colors.PINK.primary }}
                                containerStyle={{ height: '100%' }}
                            />
                        </View>
                        : null}
                        ...
                        <View style={styles.cancelContainer}>
                            ...
                            <View style={styles.cancelModalButtosContainer}>
                                ...
                                <Button
                                    ...
                                    buttonStyle={{ ...styles.cancelModalButttonStyle, backgroundColor: colors.PINK.primary }}
                                    containerStyle={styles.cancelModalButtonContainerStyle}
                                />
                            </View>
        ...
        return (
            ...
            >
                <View style={{ flex: 1, backgroundColor: "rgba(22,22,22,0.8)", justifyContent: 'center', alignItems: 'center' }}>
                    <View style={{ width: '80%', backgroundColor: colors.TRANSPARENT, borderRadius: 10, justifyContent: 'center', alignItems: 'center', flex: 1, maxHeight: 310, marginTop: 15 }}>
                        <View style={{ flex: 1, backgroundColor: colors.TRANSPARENT, justifyContent: 'center', alignItems: 'center', borderRadius: 10 }}>
                            <Image
                                style={{ width: 150, height: 150, backgroundColor: colors.TRANSPARENT, borderRadius: 10, overlayColor: 'rgba(22,22,22,0.8)' }}
                                source={require('../../assets/images/loader.gif')}
                            />
                        </View>
                        <Text style={{ color: colors.WHITE, fontSize: 16, marginTop: 10, fontFamily: 'Poppins-Regular' }}>{`We're searching drivers for you.`}</Text>
                ...
                {/* <View style={{ flex: 1, backgroundColor: "#f7f7f7", justifyContent: 'center', alignItems: 'center' }}>
                    <View style={{ width: '80%', backgroundColor: "#f7f7f7", borderRadius: 10, justifyContent: 'center', alignItems: 'center', flex: 1, maxHeight: 310, marginTop: 15 }}>
                        <View style={{ flex: 1, backgroundColor: "#f7f7f7", justifyContent: 'center', alignItems: 'center', borderRadius: 10 }}>
                            <Image
                                style={{ width: 150, height: 150, backgroundColor: "#f7f7f7", borderRadius: 10, overlayColor: '#f7f7f7' }}
                                source={require('../../assets/images/loader.gif')}
                            />
                        </View>
                        <Text style={{ color: colors.BLUE.primary, fontSize: 16, marginTop: 10, fontFamily:'Poppins-Regular' }}>{`We're searching drivers for you.`}</Text>
                    </View>
                </View> */}
        ...
        <View style={styles.mainContainer}>
            ...
            <View style={styles.addressBar}>
                ...
                <View style={styles.contentStyle}>
                    <TouchableOpacity style={styles.addressStyle1}>
                        <Text numberOfLines={1} style={[styles.textStyle, { fontSize: 14 }]}>{curBooking ? curBooking.pickup.add : ""}</Text>
                    </TouchableOpacity>
                    <View style={{ height: 1, marginRight: 0, backgroundColor: colors.GREY.btnPrimary }} />
                    <TouchableOpacity style={styles.addressStyle2}>
                        <Text numberOfLines={1} style={[styles.textStyle, { fontSize: 14 }]}>{curBooking ? curBooking.drop.add : ""}</Text>
                    </TouchableOpacity>
                </View>
            </View>
            ...
            <View style={styles.mapcontainer}>
                ...
                {role == 'driver' && appcat == 'delivery' ?
                    <TouchableOpacity
                        style={[styles.floatButton, { bottom: 180 }]}
                ...
                {role == 'driver' ?
                    <TouchableOpacity
                        style={[styles.floatButton, { bottom: 130 }]}
                        onPress={() =>
                            startNavigation()
                        }
                    >
                ...
                {curBooking && !(curBooking.bookLater && curBooking.status == 'NEW') ?
                    <TouchableOpacity
                        style={[styles.floatButton, { bottom: 70 }]}
                        onPress={() => chat()}
                    >
                        <Icon
                ...
                <View style={styles.cabDetailsContainer}>
                    ...
                    {curBooking && curBooking.status == "NEW" && curBooking.bookLater ?
                        <View style={{ flex: 1, width: width, height: 'auto', flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
                            ...
                            <Text style={{ fontFamily: 'Poppins-Medium', fontSize: 16 }}>{moment(curBooking.tripDate).format('lll')}</Text>
                        </View>
                        : null}
...
const styles = StyleSheet.create({
    ...
    cabText: { paddingLeft: 10, alignSelf: 'center', color: colors.WHITE, fontFamily: 'Poppins-Regular', fontSize: 13 },
    cabBoldText: { fontFamily: 'Poppins-Medium', fontSize: 14 },
    otpText: { alignSelf: 'center', color: colors.BLACK, fontFamily: 'Poppins-Bold' },
    ...
    cabNameText: { color: colors.GREY.btnPrimary, fontFamily: 'Poppins-Medium', fontSize: 13 },
    ...
    cabNumberText: { color: colors.BLUE.primary, fontFamily: 'Poppins-Medium', fontSize: 13 },
    ...
    driverPhotoContainer: { flex: 5, justifyContent: 'flex-end', alignItems: 'center' },
    ...
    driverNameText: { color: colors.BLUE.primary, fontFamily: 'Poppins-Medium', fontSize: 14 },
    ...
    cancelReasonText: { top: 10, color: colors.BLUE.primary, fontFamily: 'Poppins-Medium', fontSize: 20, alignSelf: 'center' },
    radioContainer: { flex: 8, alignItems: 'center' },
    radioText: { fontSize: 14, fontFamily: 'Poppins-Medium', color: colors.BLUE.primary },
    radioContainerStyle: { paddingTop: 20, marginHorizontal: 20 },
    ...
    cancelModalButttonStyle: { backgroundColor: colors.BLUE.primary },
