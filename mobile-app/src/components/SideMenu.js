...
// import { LogoSvg } from "../../assets/images/logo165x90white.svg"
    ...
    return (
        <View style={styles.mainViewStyle}>
            {auth.info && auth.info.profile ?
                <SideMenuHeader headerStyle={[auth.info.profile.usertype == 'driver' ? { marginTop: 20 } : { marginTop: 0 }]}
                    approved={auth.info.profile.approved}
                    userType={auth.info.profile.usertype}
                    userPhoto={auth.info.profile.profile_image}
                    userPhone={auth.info.profile.mobile}
                    userEmail={auth.info.profile.email}
                    userName={auth.info.profile.firstName + ' ' + auth.info.profile.lastName}>
                </SideMenuHeader>
                : null}
            <View style={styles.compViewStyle}>
                {/* <View style={[styles.vertialLine, { height: (width <= 320) ? width / 1.32 : width / 1.05 }]}></View> */}
                {!!settings ?
                    <FlatList
                        data={sideMenuList}
                                ...
                                return (
                                    <TouchableOpacity
                                        ...
                                        style={
                                            ...
                                            [styles.menuItemView, { marginTop: 0 }]
                                        }>
